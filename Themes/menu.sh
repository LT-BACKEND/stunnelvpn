...
bot
wget -q -O /usr/bin/lock "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/limit/user-lock.sh" && chmod +x /usr/bin/lock
wget -q -O /usr/bin/unlock "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/limit/user-unlock.sh" && chmod +x /usr/bin/unlock
clear
