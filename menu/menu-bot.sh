...
echo -e ""
case $opt in
01 | 1) clear ; rm -rf bot.sh && wget https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/botssh/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn ;;
