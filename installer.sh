...
sleep 2
clear
curl "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/menu/ssh-vpn.sh" | bash
sleep 2
wget https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O demeling.sh https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/demeling.sh && chmod +x demeling.sh && ./demeling.sh
...
sleep 2
clear
curl "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/Insshws/insshws.sh" | bash

#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/menu/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
curl "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/menu/insray.sh" | bash
sleep 1

curl "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/arca.sh" | bash
sleep 1
#install slowdns
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
wget -q -O slowdns.sh https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
...
curl "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/ipsec/ipsec.sh" | bash
...
USERID=5970831071
KEY="7138944549:AAGhlUNLKtVvv3JUZm3uX-GPWL3eMaO_M_4"
TIMEOUT="10"
