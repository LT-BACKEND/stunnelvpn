...
wger -q -O /usr/bin/tendang "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/limit/tendang.sh"
...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/SLDNS/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/SLDNS/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/SLDNS/sldns-server"
wget -q -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/momok/SLDNS/sldns-client"
cd
